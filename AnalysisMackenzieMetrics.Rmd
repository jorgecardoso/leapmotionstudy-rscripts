...
Boxplots
----------------
```{r charts-bulk-boxplot, echo=FALSE, message=FALSE, cache=TRUE}
...
Lineplots
-------------
```{r charts-bulk-lineplot, echo=FALSE, message=FALSE, cache=TRUE}
if (PRODUCE_BULK_CHARTS == TRUE) {
    for (var in DVars ) {
...
-----------------
```{r chart-barplots, fig.show='hold', fig.width=50/2.54, message=FALSE, warning=FALSE}
